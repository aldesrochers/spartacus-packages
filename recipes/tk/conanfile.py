...
class TkConan(ConanFile):
    ...
    def _configure_autotools(self):
        ...
        args.append("--with-tcl={}".format(os.path.join(self.deps_cpp_info["tcl"].rootpath, "lib")))
        # rules
    ...
    def package_info(self):
        self.cpp_info.names["cmake_find_package"] = "TK"
        self.cpp_info.names["cmake_find_package_multi"] = "TK"
        # append to PATH
        ...
        # TK_ROOT
        self.env_info.TK_ROOT = self.package_folder
        self.output.info("Set TK_ROOT as {}".format(self.package_folder))
        # libs
